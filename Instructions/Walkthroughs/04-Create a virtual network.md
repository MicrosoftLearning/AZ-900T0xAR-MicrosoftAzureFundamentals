...
7. في **كلا** الجهازين الظاهريين الذين تم إنشاؤهما حديثًا، قم بتعطيل كل من جدار الحماية العام والخاص عن طريق فتح قائمة ابدأ> الإعدادات> الشبكة والإنترنت> تحديد موقع جدار حماية Windows
